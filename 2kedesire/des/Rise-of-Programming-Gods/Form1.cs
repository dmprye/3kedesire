...
namespace Rise_of_Programming_Gods
{
    public partial class Form1 : Form
    {
        ...
        {
            // Set up character type ComboBoxes with available characters only
            ...
            txtBattleLog.ScrollBars = System.Windows.Forms.RichTextBoxScrollBars.Vertical; 
            txtBattleLog.ReadOnly = true;

            // Set up health labels
